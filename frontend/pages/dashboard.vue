  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          <div v-for="i in 10" :key="i" class="flex items-center justify-between p-2 hover:bg-gray-50 rounded">
            <div class="flex items-center">
              <span class="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mr-3">{{ i }}</span>
              <span>プレイヤー{{ i }}</span>
            </div>
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          <div v-for="i in 10" :key="i" class="flex items-center justify-between p-2 hover:bg-gray-50 rounded">
            <div class="flex items-center">
              <span class="w-6 h-6 bg-green-100 text-green-600 rounded-full flex items-center justify-center mr-3">{{ i }}</span>
              <span>プレイヤー{{ i }}</span>
            </div>
